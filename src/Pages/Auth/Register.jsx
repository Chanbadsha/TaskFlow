...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-200 p-6">
      <div className="relative bg-primary bg-opacity-10 backdrop-blur-lg rounded-3xl shadow-xl p-10 w-full max-w-7xl flex flex-col lg:flex-row items-center">
        
        {/* Left Side - Image */}
        <div className=" md:flex flex-1 mb-12 justify-center">
          <img className="w-10/12 h-10/12  mx-auto object-cover rounded-full shadow-lg border-4 border-white" src={signInImg} alt="Sign In" />
        </div>
        ...
        <div className="w-full lg:w-1/2">
          ...
          <p className="text-white text-center text-sm mb-6 px-4">
            Create your TaskFlow account and take control of your tasks effortlessly. 
            Stay organized, collaborate seamlessly, and boost your productivity with our intuitive task management system. 
            Join us today and streamline your workflow like never before!
          </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input {...register("userFirstName")} type="text" 
              ...
              <div>
                ...
                <input {...register("userLastName")} type="text" 
                  className="input input-bordered w-full bg-[#1E1E1E] text-white placeholder-gray-400 focus:outline-none focus:border-none"
                  placeholder="Doe" />
              </div>
            </div>
            ...
            <div>
              ...
              <input {...register("userEmail")} type="email" 
                className="input input-bordered w-full bg-[#1E1E1E] text-white placeholder-gray-400 focus:outline-none focus:border-none"
            ...
            <div>
              ...
              <input {...register("userConfirmPassword")} type="password" 
                className="input input-bordered w-full bg-[#1E1E1E] text-white placeholder-gray-400 focus:outline-none focus:border-none"
                placeholder="********" />
            </div>
    ...
    GitHub
          ...
          <div className="text-center mt-6">
            <p className="text-white">
              Already have an account? <a href="/login" className="underline text-blue-600 font-bold hover:text-blue-700">Log in</a>
            </p>
          </div>
